...
#Understand the problem
    #Pick and unexplored exit (?) and go down that path (DFT)
    #Update graph
...
# Create a set to store information upon exiting a room
...
# player.travel(travel_north)
# player.travel(travel_south)
# player.travel(travel_south)
# player.travel(travel_south)
# player.travel(travel_south)
# player.travel(travel_north)
# player.travel(travel_north)
# player.travel(travel_east)
# player.travel(travel_east)
# player.travel(travel_west)
# player.travel(travel_west)
# player.travel(travel_west)
# player.travel(travel_west)
